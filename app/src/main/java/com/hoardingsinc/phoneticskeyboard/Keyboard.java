...
public class Keyboard {
    ...
    public static class Row {
        ...
        public Row(Resources res, Keyboard parent, XmlResourceParser parser) {
            ...
            TypedArray a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard);
            defaultWidth = getDimensionOrFraction(a,
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_keyWidth,
                    parent.mDisplayWidth, parent.mDefaultWidth);
            defaultHeight = getDimensionOrFraction(a,
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_keyHeight,
                    parent.mDisplayHeight, parent.mDefaultHeight);
            defaultHorizontalGap = getDimensionOrFraction(a,
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_horizontalGap,
                    parent.mDisplayWidth, parent.mDefaultHorizontalGap);
            verticalGap = getDimensionOrFraction(a,
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_verticalGap,
                    parent.mDisplayHeight, parent.mDefaultVerticalGap);
            a.recycle();
            a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Row);
            rowEdgeFlags = a.getInt(com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Row_rowEdgeFlags, 0);
            mode = a.getResourceId(com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Row_keyboardMode,
                    0);
        }
    }
    ...
    public static class Key {
        ...
        public Key(Resources res, Keyboard.Row parent, int x, int y, XmlResourceParser parser) {
            ...
            a.recycle();
            a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key);
            this.x += gap;
            TypedValue codesValue = new TypedValue();
            a.getValue(com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_codes,
                    codesValue);
            ...
            iconPreview = a.getDrawable(com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_iconPreview);
            if (iconPreview != null) {
                iconPreview.setBounds(0, 0, iconPreview.getIntrinsicWidth(),
                        iconPreview.getIntrinsicHeight());
            }
            popupCharacters = a.getText(
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_popupCharacters);
            popupResId = a.getResourceId(
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_popupKeyboard, 0);
            repeatable = a.getBoolean(
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_isRepeatable, false);
            modifier = a.getBoolean(
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_isModifier, false);
            sticky = a.getBoolean(
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_isSticky, false);
            edgeFlags = a.getInt(com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_keyEdgeFlags, 0);
            edgeFlags |= parent.rowEdgeFlags;

            icon = a.getDrawable(
                    com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_keyIcon);
            if (icon != null) {
                icon.setBounds(0, 0, icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
            }
            label = a.getText(com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_keyLabel);
            text = a.getText(com.hoardingsinc.phoneticskeyboard.R.styleable.Keyboard_Key_keyOutputText);
            ...
            while ((event = parser.next()) != XmlResourceParser.END_DOCUMENT) {
                if (event == XmlResourceParser.START_TAG) {
                    ...
                    if (TAG_ROW.equals(tag)) {
                        ...
                        mKeys.add(key);
                        if (key.codes != null && key.codes.length > 0 && key.codes[0] == KEYCODE_SHIFT) {
